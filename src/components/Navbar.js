...
export default function Navbar(props) {
  return (
    ...
    <div className="container-fluid">
      <a className="navbar-brand" href="https://github.com/Barik07/ReactTest">{props.title}</a>
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          {/* <li className="nav-item">
            <li className="nav-link active" aria-current="page" href="https://github.com/Barik07/ReactTest">Home</li>
          </li> */}
          {/* <li className="nav-item">
            <li className="nav-link" href="/">{props.aboutText}</li>
          </li> */}
        </ul>
       ...
       <div className="bg-info rounded mx-2 my-2" onClick={()=>{props.toggleMode('info')}} style={{height: '30px',width:'30px',cursor:'pointer'}}></div>
